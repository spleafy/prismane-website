...
`Gradient` extends [Box](/docs/components-api/layout/box-api) component's props.
...
`Gradient` extends [Box](/docs/components-api/layout/box-api) component's CSS classes.
