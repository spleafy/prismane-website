...
| `position` | [PrismanePositions](/docs/getting-started/overview#global-types)   | The position of the badge.      | top-start |
| `color`    | [PrismaneColors](/docs/getting-started/overview#global-types)      | The color of the badge.         | -         |
| `size`     | [PrismaneBreakpoints](/docs/getting-started/overview#global-types) | The size of the badge.          | -         |
