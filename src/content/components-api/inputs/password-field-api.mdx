...
`PasswordField` extends [Field](/docs/components-api/inputs/field-api) component's props.

## CSS

`PasswordField` extends [Field](/docs/components-api/inputs/field-api) component's CSS classes.
