...
`PinField` extends [Field](/docs/components-api/inputs/field-api) component's props.
...
`PinField` extends [Field](/docs/components-api/inputs/field-api) component's CSS classes.
