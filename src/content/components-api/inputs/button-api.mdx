...
`Button` extends [Transition](/docs/components-api/miscellaneous/transition-api) component's props.
...
`Button` extends [Transition](/docs/components-api/miscellaneous/transition-api) component's CSS classes.
