...
`Checkbox` extends [Flex](/docs/components-api/layout/flex-api), [Transition](/docs/components-api/miscellaneous/transition-api) and [PrismaneFieldComponent](/docs/getting-started/globals#prismanefieldcomponent-type) component's props.
...
`Checkbox` extends [Flex](/docs/components-api/layout/flex-api), [Transition](/docs/components-api/miscellaneous/transition-api) components' CSS classes.
