...
`Radio` extends [Flex](/docs/components-api/flex-api), [Transition](/docs/components-api/transition-api) and [PrismaneFieldComponent](/docs/getting-started/overview) component's props.
