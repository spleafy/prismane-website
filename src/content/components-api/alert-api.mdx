...
`Alert` extends [Flex](/docs/components-api/flex-api) and [Animation](/docs/components-api/animation-api) components' props.
...
`Alert.Title` extends [Text](/docs/components-api/text-api) component's props.

### Alert.Description

`Alert.Description` extends [Text](/docs/components-api/text-api) component's props.

## CSS

### Alert

`Alert` extends [Flex](/docs/components-api/flex-api) and [Animation](/docs/components-api/animation-api) components' CSS classes.
...
`Alert.Title` extends [Text](/docs/components-api/text-api) component's CSS classes.
...
`Alert.Description` extends [Text](/docs/components-api/text-api) component's CSS classes.
