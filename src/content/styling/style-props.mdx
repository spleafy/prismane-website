...
<Alert variant="warning">
  ...
  <Alert.Description>
    When wanting to provide pseudo classes to the given property, you have to
    wrap the property value inside an array. The first cell in the array is the
    base value and the second one is an object. The object's key is the name of
    the pseudo class.
  </Alert.Description>
</Alert>
