...
and can be useful during development. They are all exported from the `@prismane/core` entry.
...
PrismaneShades is a type that is used to provide a predefined set of shades for every color in Prismane's color pallete.
...
PrismaneAnimations is a type that is used to provide a predefined set of animations each of which is a valid prop to the [`Animation` component](docs/components/miscellaneous/animation).
...
PrismaneTransitions is a type that is used to provide a predefined set of transitions each of which is a valid value to the `transition` prop of our [`Transition` component](docs/components/miscellaneous/transition).
...
PrismaneFieldComponent is a type that is used to provide a set of props to each of our [field components](docs/components/getting-started#inputs).
