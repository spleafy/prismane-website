...
By default, `Chip` uses the `primary` color. The `Chip` accepts all of [PrismaneColors](/docs/getting-started/overview#global-types) as values of the `color` prop.
...
The `Chip` component supports all of the [PrismaneBreakpoints](/docs/getting-started/overview#global-types) as values for the `size` prop.
