...
The `Icon` component provides a frame around any icon and also provides the cosistency in sizing, by providing a pre-built set of sizes using the `size` prop.
