...
The `CloseButton` component extends the [Button](/docs/components/button) component and it's respective props. This allows for changing the colors of the `CloseButton` to any color in [PrismaneColors](/docs/getting-started/globals#prismanecolors-type)
