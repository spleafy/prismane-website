...
The `Drawer` component's `size` prop has supporort for all of [PrismaneBreakpoints](/docs/getting-started/overview#global-types) and any other CSS size. The `size` property will change the width or height of the `Drawer` depending on the
