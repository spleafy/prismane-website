---
title: 'Avatar API'
description: "Learn about the Avatar component's props and CSS classes."
---
...
`Avatar` extends [Box](/docs/components-api/box-api) component's props.
...
`Avatar` extends [Box](/docs/components-api/box-api) component's CSS classes.
