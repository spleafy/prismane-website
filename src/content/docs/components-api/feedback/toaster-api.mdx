---
title: 'Toaster API'
description: "Learn about the Toaster component's props and CSS classes."
---
...
`Toaster` extends [Flex](/docs/components-api/flex-api) component's props.
...
`Toaster` extends [Flex](/docs/components-api/flex-api) component's CSS classes.
