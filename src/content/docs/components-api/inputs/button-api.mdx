---
title: 'Button API'
description: "Learn about the Button component's props and CSS classes."
---
...
| `color`       | [PrismaneColors](/docs/getting-started/globals#prismanecolors-type)           | Changes the color of the button.                                 | primary |
| `size`        | [PrismaneBreakpoints](/docs/getting-started/globals#prismanebreakpoints-type) | Changes the size of the button.                                  | base    |
