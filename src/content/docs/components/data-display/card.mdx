---
title: 'Card'
description: 'Card displays a container that groups and displays content.'
versatile: true
---
...
<Card w={480}>
  ...
  Prismane was a mixture of passion, dedication and hard work. Numerous days of
  development led to a great product adapted by many.
...
`Card` is a [Versatile Component](/docs/getting-started/versatile-components), it's default root element is - _div_, but it can be changed to any other element or component with the _as_ prop:
