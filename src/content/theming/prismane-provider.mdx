...
component This component is imported from  `@prismane/core/themes`.

## Basic Usage

If you just want to use the  `base` theme in your application, simply wrap your app's main component with the
...
<Note>
    Importing and wrapping your application with the `<PrismaneProvider/>` is a requirement in order to provide the
    theming functionality across your application.
</Note>
...
export default App;
```
Now we know how to create own own custom theme and use it in our PrismaneProvider.
Let's see how we can apply some more advanced theming capabilities in our [Advanced Customization](/docs/theming/advanced-customization).
