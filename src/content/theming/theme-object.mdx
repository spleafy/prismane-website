...
Theming is a fundamental capability in building great user interfaces.
It makes it possible to apply a unified style throughout your application, improving the user experience and preserving visual coherence.

Prismane is placing strong emphasis on powerful theming capabilities.
By defining a single theme object, you can control the overall look and feel of all your application's components, allowing you to craft beautiful and cohesive user interfaces.
...
- `Mode` - You can control whether the theme is in dark or light mode.
...
- `Spacing` - Define consistent values for margins, paddings, and gutters, ensuring a clean and organized UI layout.
- `Border Radius` - Set the global border radius for a unified aesthetic, or adjust it for specific components to add
visual distinction.
- `Font` - Set the global font family to be used across the whole interface of your application.
...
Prismane empowers you to build flexible and adaptable user interfaces that resonate with your users.
