  ...
  return (
    ...
    >
      <div className="flex max-w-[1440px] w-full items-center justify-between">
        ...
        <div
          className={`absolute md:static pt-20 top-0 h-screen dark:shadow-base-500/5 shadow-base-900/5 md:shadow-none flex items-center gap-8 transition-all flex-col md:flex-row w-full md:w-fit md:h-fit bg-white dark:bg-[#0A0118] md:bg-transparent md:dark:bg-transparent p-5 md:!p-0 ${
